...
import type { NavItem, Schedule, ScheduleDetail, TurnosByTab } from './_components/types';

// ponytail: mock data until the Turno domain exists in src/; swap for a controller call then.
const turnosByTab: TurnosByTab = {
    proximos: [
        {
...
const pendingCount = turnosByTab.pendientes.reduce((n, g) => n + g.items.length, 0);
...
export default function TurnosPage() {
    return (
        <DashboardShell
            user={{ name: 'Martina Fossati', role: 'Dueña', initials: 'MF' }}
            navItems={navItems}
